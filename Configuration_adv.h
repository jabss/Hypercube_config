 ...
 */
 // SEPJSIL - SO PARA EXPERIMENTAR
#define Z_STEPPER_AUTO_ALIGN
#if ENABLED(Z_STEPPER_AUTO_ALIGN)
  // Define probe X and Y positions for Z1, Z2 [, Z3]
  // SEPJSIL - Alterei os valores de X (40, 270)
  #define Z_STEPPER_ALIGN_X { 24, 277 }
 ...
 */
 //SEPJSIL - descomentei aqui - necessario para o FILAMENT_RUNOUT_SENSOR
 ...
 */
  ...
  // SEPJSIL alterei de 0.5 para 0.4 - Quanto maior mais força (1= feature off)
  #define HOLD_MULTIPLIER    0.7  // Scales down the holding current from run current
  #define INTERPOLATE       true  // Interpolate X/Y/Z_MICROSTEPS to 256

  #if AXIS_IS_TMC(X)
    // SEPJSIL. X/Y/ZZ steppers are 17HM0423, with 2300mA peak current. Dividing it by 1.414 = 1626ma
  ...
  #if AXIS_IS_TMC(E0)
    // SEPJISL E0 stepper is 42HS40-1704 - Peak 1700mA. Dividing it by 1.414  = 1202
   ...
   */
  #define STEALTHCHOP_XY    //SEPJSIL: StallGuard is only active when the driver is in spreadCycle mode.
